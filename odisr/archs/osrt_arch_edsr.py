...
# from odisr.archs.rfpoub import RepRFN, SCPA_rep
from odisr.archs.edsr_shirft_uni import EDSR
from odisr.archs import common

from basicsr.utils.registry import ARCH_REGISTRY
from basicsr.archs.arch_util import to_2tuple, trunc_normal_, flow_warp, DCNv2Pack
# from odisr.archs.spin import SPIN
...
class OSRT(nn.Module):
    ...
    def __init__(self,
        ...
        # self.spin = SPIN(colors=3, dim=60, block_num=8, heads=1, qk_dim=24, mlp_dim=72, stoken_size=[12, 16, 20, 24, 12, 16, 20, 24], upscale=2)
        # self.pan = SCPA(60,2,1,1)
        self.edsr = EDSR(conv=common.default_conv)
        # self.layers = nn.ModuleList()
