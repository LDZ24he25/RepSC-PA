...
os.makedirs('/media/ahu/Storage3/ldz/OSRT-master/dataset/DF2K-ODI/HR', exist_ok=True)
os.makedirs('/media/ahu/Storage3/ldz/OSRT-master/dataset/DF2K-ODI/LR/X2', exist_ok=True)
os.makedirs('/media/ahu/Storage3/ldz/OSRT-master/dataset/DF2K-ODI/LR/X4', exist_ok=True)
os.makedirs('/media/ahu/Storage3/ldz/OSRT-master/dataset/DF2K-ODI/LR/X8', exist_ok=True)
os.makedirs('/media/ahu/Storage3/ldz/OSRT-master/dataset/DF2K-ODI/LR/X16', exist_ok=True)
...
save_pth = '/media/ahu/Storage3/ldz/OSRT-master/dataset/DF2K-ODI'
img_list = gb.glob('/media/ahu/Storage3/ldz/DATASET/DIV2K_train_HR/*') + gb.glob('/media/ahu/Storage3/ldz/DATASET/Flickr2K/Flickr2K_HR/*')
pbar = tqdm(total=len(img_list), unit='image', desc='Extract')
pool = Pool(20)
for i, path in enumerate(img_list):
    pool.apply_async(extract_odi_subimage, args=(path, save_pth, i, ), callback=lambda arg: pbar.update(1))
pool.close()
pool.join()
pbar.close()
