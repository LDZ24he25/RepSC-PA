...
from odisr.archs.esrt import MLABlock
...
class OSRT(nn.Module):
    ...
    def __init__(self,
        ...
        #     layer = MLABlock(
        #         n_feat = 60,dim=540, num_heads=10, mlp_ratio=4., qkv_bias=False, qk_scale=None, drop=0., attn_drop=0.,
        #          drop_path=0., act_layer=nn.ReLU, norm_layer=nn.LayerNorm
        #         )
        #     self.layers.append(layer)

        # self.conv1= nn.Conv2d(32, 60, 3,1 ,1)
        # self.conv2 = nn. Conv2d(60, 32, 3,1,1)
