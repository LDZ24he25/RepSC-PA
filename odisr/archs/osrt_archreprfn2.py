...
from odisr.archs.rfpoub2 import RepRFN
...
class OSRT(nn.Module):
    ...
    def forward(self, x, condition):
        ...
        if self.upsampler == 'pixelshuffledirect':
            ...
            # # print(x.shape, flow.shape,'0000000')
            # _x = flow_warp(x,flow, interp_mode='bilinear', padding_mode='border')

            x = self.reprfn(x, condition)
