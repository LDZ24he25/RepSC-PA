...
class SCPA(nn.Module):
    ...
    def __init__(self, nf, reduction=2, stride=1, dilation=1):
        ...
        self.conv_out = nn.Conv2d(nf*2, nf, 1, 1, 0, bias=False)
...
class OSRT(nn.Module):
    ...
    def __init__(self,
        ...
        self.scpa5 = SCPA(60,2,1,1)
        self.scpa6 = SCPA(60,2,1,1)
        self.scpa7 = SCPA(60,2,1,1)
        self.scpa8 = SCPA(60,2,1,1)

        # self.fam2 = FAM(in_channels=60, out_channels=60, kernel_size=3, stride=1, padding=1, bias=True, split=2, reduction=2)
        self.scpa9 = SCPA(60,2,1,1)
        self.scpa10 = SCPA(60,2,1,1)
        self.scpa11 = SCPA(60,2,1,1)
        self.scpa12 = SCPA(60,2,1,1)
        # self.scpa13 = SCPA(60,2,1,1)
        # self.scpa14 = SCPA(60,2,1,1)
        # self.scpa15 = SCPA(60,2,1,1)
        # self.scpa16 = SCPA(60,2,1,1)
    ...
    def forward(self, x, condition):
        ...
        if self.upsampler == 'pixelshuffledirect':
            ...
            out5 = self.scpa5(out_lr,condition)
            out6 = self.scpa6(out5,condition)
            out7 = self.scpa7(out6,condition)
            out8 = self.scpa8(out7,condition)
            ...
            # x_fam2 = self.fam2(out_lr)
            out9 = self.scpa9(out_lr,condition)
            out10 = self.scpa10(out9,condition)
            out11 = self.scpa11(out10,condition)
            out12 = self.scpa12(out11,condition)
            # out13 = self.scpa13(out12,condition)
            # out14 = self.scpa14(out13,condition)
            # out15 = self.scpa15(out14,condition)
            # out16 = self.scpa16(out15,condition)
